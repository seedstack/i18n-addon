...
public class TranslationServiceImplTest {
    ...
    public void setUp() {
        ...
        localizationService = new ICUBasedLocalizationService(localeService, keyRepository);
        translationService = new TranslationServiceImpl(keyRepository, localizationService);
    }
