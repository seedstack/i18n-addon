 ...
 *         Date: 28/11/13
 */
public class ICUTranslationService implements TranslationService {
     ...
     */
    @Inject
    public ICUTranslationService(KeyRepository keyRepository, LocalizationService localizationService) {
    ...
    public Map<String, String> getTranslationsForLocale(String locale) {
        ICULocalizationService icuLocalizationService = (ICULocalizationService) localizationService;
        Map<String, String> translations = new HashMap<String, String>();
        List<ULocale> localeIterator = icuLocalizationService.getParentLocale(new ULocale(locale));

        for (Key key : keyRepository.loadAll()) {
            Translation translation = icuLocalizationService.getTranslationWithFallBack(key, localeIterator);
            if (translation != null) {
