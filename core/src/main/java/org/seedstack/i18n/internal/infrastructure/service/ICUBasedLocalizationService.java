 ...
 */
public class ICUBasedLocalizationService implements LocalizationService {
     ...
     */
    @Inject
    public ICUBasedLocalizationService(LocaleService localeService, KeyRepository keyRepository) {
        this.localeService = (LocaleServiceImpl) localeService;
